...
use CasParser\ServiceContracts\CdslContract;
...
final class CdslService implements CdslContract
{
     ...
     * @api
     */
    public CdslRawService $raw;

    /**
     * @api
     */
    public FetchService $fetch;
    ...
    {
        $this->raw = new CdslRawService($client);
        $this->fetch = new FetchService($client);
    }
    ...
    public function parsePdf(
        ...
        $response = $this->raw->parsePdf(params: $params, requestOptions: $requestOptions);
