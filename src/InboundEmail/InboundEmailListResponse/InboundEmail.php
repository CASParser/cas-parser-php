...
namespace CasParser\InboundEmail\InboundEmailListResponse;

use CasParser\Core\Attributes\Optional;
use CasParser\Core\Concerns\SdkModel;
use CasParser\Core\Contracts\BaseModel;
use CasParser\InboundEmail\InboundEmailListResponse\InboundEmail\AllowedSource;
use CasParser\InboundEmail\InboundEmailListResponse\InboundEmail\Status;

/**
 * An inbound email address for receiving forwarded CAS emails.
 *
 * @phpstan-type InboundEmailShape = array{
 ...
 * }
 */
final class InboundEmail implements BaseModel
{
    /** @use SdkModel<InboundEmailShape> */
    use SdkModel;
