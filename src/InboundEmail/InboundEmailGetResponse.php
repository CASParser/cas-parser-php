...
use CasParser\InboundEmail\InboundEmailGetResponse\AllowedSource;
use CasParser\InboundEmail\InboundEmailGetResponse\Status;

/**
 * An inbound email address for receiving forwarded CAS emails.
 *
 * @phpstan-type InboundEmailGetResponseShape = array{
 ...
 * }
 */
final class InboundEmailGetResponse implements BaseModel
{
    /** @use SdkModel<InboundEmailGetResponseShape> */
    use SdkModel;
