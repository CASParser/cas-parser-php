...
/**
 * @phpstan-type InboundEmailDeleteResponseShape = array{
 *   msg?: string|null, status?: string|null
 * }
 */
final class InboundEmailDeleteResponse implements BaseModel
{
    /** @use SdkModel<InboundEmailDeleteResponseShape> */
    use SdkModel;
