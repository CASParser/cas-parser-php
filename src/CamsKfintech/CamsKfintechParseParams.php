 ...
 *
 * @see CasParser\Services\CamsKfintechService::parse()
 *
 * @phpstan-type CamsKfintechParseParamsShape = array{
 *   password?: string|null, pdfFile?: string|null, pdfURL?: string|null
 * }
 */
final class CamsKfintechParseParams implements BaseModel
{
    /** @use SdkModel<CamsKfintechParseParamsShape> */
    use SdkModel;
    use SdkParams;
