...
use CasParser\CamsKfintech\UnifiedResponse\DematAccount\Holdings\Aif;
use CasParser\CamsKfintech\UnifiedResponse\DematAccount\Holdings\CorporateBond;
use CasParser\CamsKfintech\UnifiedResponse\DematAccount\Holdings\DematMutualFund;
use CasParser\CamsKfintech\UnifiedResponse\DematAccount\Holdings\Equity;
use CasParser\CamsKfintech\UnifiedResponse\DematAccount\Holdings\GovernmentSecurity;
use CasParser\Core\Attributes\Optional;
use CasParser\Core\Concerns\SdkModel;
use CasParser\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type AifShape from \CasParser\CamsKfintech\UnifiedResponse\DematAccount\Holdings\Aif
 * @phpstan-import-type CorporateBondShape from \CasParser\CamsKfintech\UnifiedResponse\DematAccount\Holdings\CorporateBond
 * @phpstan-import-type DematMutualFundShape from \CasParser\CamsKfintech\UnifiedResponse\DematAccount\Holdings\DematMutualFund
 * @phpstan-import-type EquityShape from \CasParser\CamsKfintech\UnifiedResponse\DematAccount\Holdings\Equity
 * @phpstan-import-type GovernmentSecurityShape from \CasParser\CamsKfintech\UnifiedResponse\DematAccount\Holdings\GovernmentSecurity
 *
