 ...
 *
 * @see CasParser\Services\CdslService::parsePdf()
 *
 * @phpstan-type CdslParsePdfParamsShape = array{
 *   password?: string|null, pdfFile?: string|null, pdfURL?: string|null
 * }
 */
final class CdslParsePdfParams implements BaseModel
{
    /** @use SdkModel<CdslParsePdfParamsShape> */
    use SdkModel;
    use SdkParams;
